...
## [1.0.0](https://github.com/eyre-rs/eyre/compare/eyre-v0.6.12...eyre-v1.0.0) - 2026-08-10
...
- Add safety comments to downcast-related code
- Eliminate pointer->reference->pointer during downcast
- Use std `backtrace` on `stable` ([#284](https://github.com/eyre-rs/eyre/pull/284))
