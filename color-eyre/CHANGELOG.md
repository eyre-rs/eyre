...
## [0.7.0](https://github.com/eyre-rs/eyre/compare/color-eyre-v0.6.5...color-eyre-v0.7.0) - 2026-08-10
...
- match `backtrace::capture` under v0 symbol mangling ([#295](https://github.com/eyre-rs/eyre/pull/295))
- Make tests compatible with v0 symbol mangling ([#288](https://github.com/eyre-rs/eyre/pull/288))
